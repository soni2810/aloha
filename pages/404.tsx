    ...
    <div className="-mx-4 flex">
      <div className="w-full px-4">
        <div className="mx-auto max-w-[400px] text-center">
          <h2
            className="mb-2 text-[50px] font-bold leading-none text-dark sm:text-[80px] md:text-[100px]"
          >
            404
          </h2>
          ...
          <Link
            href="/"
            className="hover:text-primary inline-block rounded-lg border border-dark px-8 py-3 text-center text-base font-semibold text-dark transition hover:bg-dark"
          >
            Go To Home
          </Link>
        </div>
